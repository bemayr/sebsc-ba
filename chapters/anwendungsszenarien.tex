...
Beim Wechsel oder der Neuinstallation des Systems genügt die Mitnahme der Shell-Konfiguration um das gesamte Werkzeugset auch auf dem neuen System verwenden zu können.
...
In \cref{fig:greet-output} ist das Resultat des Programmes zu sehen, nachdem es wieder in diesem Linux-Container ausgeführt wurde.

Diese schnelle Möglichkeit des Cross-Compilings ermöglicht ein schnelles Testen der Plattformunabhängigkeit des Quelltextes.
...
Für die plattformübergreifende Übersetzung existieren bereits zahlreiche fertige Docker-Images.
dockcross\footnote{\url{https://github.com/dockcross/dockcross}} ist eine Sammlung an Docker-Images für das Cross-Compiling.

In \cref{lst:dockercross-arm-greet} sind die notwendigen Kommandos dargestellt, die zum Erstellen des Hello-World-Programms aus \cref{lst:greet.c} gegen die armv7-Plattform notwendig sind.
