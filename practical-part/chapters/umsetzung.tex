...
\lstinputlisting[caption=\emph{.bashrc} (Bash-Konfigurationsdatei),label={lst:.bashrc},language=bash]{listings/.bashrc}
...
\lstinputlisting[caption=\emph{docker-webdev.ps1} (Start-Skript des Containers),label={lst:docker-webdev.ps1}]{listings/docker-webdev.ps1}
